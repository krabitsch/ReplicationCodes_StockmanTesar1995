...
Nbar=1/5;                    % Home steady state labor (as ratio of total time endowment)
Nsbar=1/5;                   % Foreign steady state labor (as ratio of total time endowment)
